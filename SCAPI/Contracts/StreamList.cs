...
namespace SCAPI.Contracts
{
	...
	public class StreamList
	{
		...
		public List<StreamListObject> Collection { get; set; }
	...
	public class StreamListObject
	{
		...
		public StreamTrack Track { get; set; }
		...
		public DateTime CreatedAt
		{
			...
			{
				DateTime date;
				DateTime.TryParse(created_at, out date);
				return date;
			}
			set { created_at = value.ToString(CultureInfo.InvariantCulture); }
		}
	}
